...
const COPY = {
  ar: {
    ...
    nextPrimary: 'ابدأ Gate 2B3B على فرع مستقل',
    nextPrimaryText: 'Gate 2B3A مُعتمَدة نهائيًا بعد جولتي مراجعة مستقلتين: 1,959 اختبار backend ناجح و3/3 تزامن PostgreSQL وبناء frontend ناجح. الخطوة التالية Gate 2B3B لتوحيد تدقيق أحداث المصادقة ودورة الجلسات، بعد checkpoint محلي وبدون push.',
  ...
  en: {
    ...
    nextPrimary: 'Start Gate 2B3B on a separate branch',
    nextPrimaryText: 'Gate 2B3A is finally accepted after two independent review rounds: 1,959 backend tests passed, 3/3 live PostgreSQL concurrency tests passed, and the frontend build passed. Next is Gate 2B3B for unified authentication-event auditing and session lifecycle, after a local checkpoint and without pushing.',
