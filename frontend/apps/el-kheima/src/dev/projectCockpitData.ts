...
export const PROJECT_MODULES: ProjectModule[] = [
  {
    ...
    health: 'attention',
    note: {
      ar: 'Gate 2 بالكامل مُعتمَدة: bootstrap وTOTP وstep-up وتدقيق المصادقة وعائلات refresh وإدارة الجلسات اجتازت المراجعة المستقلة. التالي Gate 3 لأساس اللغة والديزاين واختبارات الفرونت.',
      en: 'Gate 2 is fully accepted: bootstrap, TOTP, step-up, authentication auditing, refresh families, and session management passed independent review. Gate 3 UI/i18n/test foundations are next.',
    },
  },
  {
    id: 'dining',
...
export const PROMPT_SUGGESTIONS: PromptSuggestion[] = [
  ...
  {
    id: 'gate3-foundation',
    title: { ar: 'نفّذ Gate 3 — أساس اللغة والديزاين والاختبار', en: 'Implement Gate 3 — i18n, design, and test foundations' },
    description: { ar: 'Gate 2 مُعتمَدة. ابنِ runtime عربي/إنجليزي صحيح، baseline فعلي لتبنّي الـDesign System، وfrontend quality harness صغير قابل للصيانة قبل ترجمة الشاشات بالجملة.', en: 'Gate 2 is accepted. Build a correct Arabic/English runtime, a real design-system adoption baseline, and a small maintainable frontend quality harness before translating screens in bulk.' },
    mode: 'implement',
    scope: 'frontend',
    phase: 'staff-i18n-foundation',
    objective: {
