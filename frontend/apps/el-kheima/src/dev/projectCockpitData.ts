...
export const PROJECT_SNAPSHOT = {
  ...
  sourcePath: 'wagdy.md',
  sourceRevision: 'c78e7ba fix(security): enforce secure TOTP bootstrap and recovery',
  branchAtSnapshot: 'gate-2b2-totp-bootstrap',
  baseline: {
    modules: 13,
    backendTestsPassed: 1924,
    postgresOnlySkipped: 13,
    alembicHeads: 1,
    alembicHead: 'a7c2e91f4b6d',
