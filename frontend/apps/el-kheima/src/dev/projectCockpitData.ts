...
export const PROJECT_MODULES: ProjectModule[] = [
  {
    ...
    health: 'attention',
    note: {
      ar: 'الأساس موجود؛ حماية السوبر أدمن و2FA وقت الدخول والإعدادات المقيّدة هي البوابة التالية.',
      en: 'The foundation exists; Super Admin protection, login-time 2FA, and typed settings are the next gate.',
    },
  },
  {
    id: 'dining',
...
export const PROJECT_ROADMAP: RoadmapStep[] = [
  ...
  },
  {
    ...
    outcome: { ar: 'حماية الصلاحية وآخر حساب و2FA وstep-up والجلسات والتدقيق.', en: 'Protect authority, last account, 2FA, step-up, sessions, and audit.' },
    gate: { ar: 'اختبارات منع التصعيد والقفل الذاتي والتزامن.', en: 'Privilege-escalation, self-lockout, and concurrency tests.' },
  },
  {
...
export const PROJECT_RISKS: ProjectRisk[] = [
  ...
  },
  {
    ...
    severity: 'high',
    area: 'core',
    title: { ar: 'حماية السوبر أدمن غير مكتملة', en: 'Super Admin safety is incomplete' },
    detail: { ar: 'Explicit deny والـoverrides وآخر حساب نشط وlogin-time TOTP تحتاج إصلاحًا واختبارات.', en: 'Explicit denies, overrides, last-active-account protection, and login-time TOTP need fixes and tests.' },
  },
  {
...
export const PROMPT_SUGGESTIONS: PromptSuggestion[] = [
  ...
  {
    id: 'superadmin-audit',
    title: { ar: 'ابدأ بأمان السوبر أدمن', en: 'Start with Super Admin safety' },
    description: { ar: 'تقرير Root Cause وخطة المرحلة التالية قبل أي تعديل.', en: 'Root-cause report and next-phase plan before editing.' },
    mode: 'plan',
    scope: 'core',
    phase: 'superadmin-backend',
    objective: {
      ar: 'راجع تنفيذ super_admin الحالي وأثبت فجوات explicit deny وpermission overrides والحماية من self-lockout وآخر حساب نشط وlogin-time TOTP. اعرض Root Cause والملفات والاختبارات وخطة مرحلة واحدة، ثم توقف قبل التعديل.',
      en: 'Review the current super_admin implementation and prove the explicit-deny, permission-override, self-lockout, last-active-account, and login-time TOTP gaps. Present root cause, files, tests, and one bounded phase, then stop before editing.',
    },
