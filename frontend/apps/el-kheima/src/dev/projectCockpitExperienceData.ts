...
export const SMART_EXECUTION_PHASES: SmartExecutionPhase[] = [
  ...
  { id: 'admin-security', order: 2, status: 'ready', title: { ar: 'أمان مركز التحكم', en: 'Control-plane security' }, purpose: { ar: 'حماية Super Admin والجلسات وTOTP وstep-up والتدقيق.', en: 'Protect Super Admin, sessions, TOTP, step-up, and audit.' }, dependencies: { ar: 'Gate 1 المطلوبة اتعمدت؛ يبدأ بعد checkpoint نظيف.', en: 'The required Gate 1 slice is accepted; start after a clean checkpoint.' }, exitGate: { ar: 'منع escalation/self-lockout بالتزامن في السيرفر.', en: 'Server-side escalation/self-lockout prevention under concurrency.' } },
