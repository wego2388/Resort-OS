...
const props = withDefaults(defineProps<{
  purpose: 'user_provision' | 'user_role_update' | 'permission_override_upsert' | 'permission_override_revoke' | 'setting_upsert' | 'session_revoke' | 'other_sessions_revoke' | 'payment_void' | 'dining_refund' | 'user_unlock' | 'user_force_2fa_reset'
