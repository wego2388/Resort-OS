...
const STRICT_FILES = [
  ...
  'src/views/admin/HRView.vue',
  'src/views/ops/ReceptionView.vue',
  'src/views/ops/BookingsView.vue',
  'src/views/ops/RoomsView.vue',
  'src/views/ops/HousekeepingView.vue',
  'src/views/admin/BeachAdminView.vue',
  'src/views/pos/BeachMapView.vue',
  'src/views/pos/BeachPOSView.vue',
  'src/views/admin/FinanceView.vue',
  'src/views/admin/DiningMenuView.vue',
  'src/views/admin/RecipesView.vue',
  'src/views/admin/FoodCostReportView.vue',
  'src/views/admin/TimeshareView.vue',
  'src/views/admin/LeasingView.vue',
  'src/views/admin/InventoryView.vue',
  'src/views/admin/MaintenanceView.vue',
  'src/views/admin/AnalyticsView.vue',
  'src/views/admin/HubManagementView.vue',
  'src/views/admin/QRGeneratorView.vue',
  'src/views/admin/EInvoiceView.vue',
