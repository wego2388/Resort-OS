  ...
  <header class="sticky top-0 z-30 bg-brand-charcoal/95 backdrop-blur text-white shadow-md">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
      ...
      <nav class="hidden md:flex items-center gap-6 font-semibold text-sm">
        ...
        <a href="#rooms" class="rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 hover:text-brand-sunset transition-colors">{{ t('marketing.nav.rooms') }}</a>
        ...
        <a href="#contact" class="rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 hover:text-brand-sunset transition-colors">{{ t('marketing.nav.contact') }}</a>
      </nav>
      ...
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <!-- Mobile menu trigger — only real way to reach Rooms/Contact on a phone -->
        <button
          type="button"
          class="md:hidden inline-flex items-center justify-center w-11 h-11 rounded-full bg-white/10 hover:bg-white/20 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
    ...
    <nav
      v-if="mobileMenuOpen"
      class="md:hidden border-t border-white/10 px-4 py-3 flex flex-col gap-1 font-semibold text-sm bg-brand-charcoal"
    >
      ...
      <a href="#contact" class="rounded-lg px-3 py-2.5 min-h-[44px] flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 hover:bg-white/10 transition-colors" @click="mobileMenuOpen = false">{{ t('marketing.nav.contact') }}</a>
