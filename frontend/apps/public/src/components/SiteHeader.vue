  ...
  <header class="sticky top-0 z-30 bg-brand-charcoal/95 backdrop-blur text-white shadow-md">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
      ...
      <nav class="hidden lg:flex items-center gap-5 font-semibold text-sm">
        ...
        <RouterLink to="/beach" class="rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 hover:text-brand-sunset transition-colors">{{ t('marketing.nav.beach') }}</RouterLink>
    ...
    >
      ...
      <RouterLink to="/#rooms" class="rounded-lg px-3 py-2.5 min-h-[44px] flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 hover:bg-white/10 transition-colors" @click="mobileMenuOpen = false">{{ t('marketing.nav.rooms') }}</RouterLink>
      <RouterLink to="/beach" class="rounded-lg px-3 py-2.5 min-h-[44px] flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 hover:bg-white/10 transition-colors" @click="mobileMenuOpen = false">{{ t('marketing.nav.beach') }}</RouterLink>
