...
export const ENDPOINTS = {
  ...
  finance: {
    ...
    closeYear: (y: number) => `/api/v1/finance/periods/${y}/close-year`,
    ...
    expenseVoid: (id: number) => `/api/v1/finance/expenses/${id}/void`,
    expensePay: (id: number) => `/api/v1/finance/expenses/${id}/pay`,
    expensePayments: (id: number) => `/api/v1/finance/expenses/${id}/payments`,
    custodies: '/api/v1/finance/custodies',
    custody: (id: number) => `/api/v1/finance/custodies/${id}`,
    custodySettle: (id: number) => `/api/v1/finance/custodies/${id}/settle`,
    custodyVoid: (id: number) => `/api/v1/finance/custodies/${id}/void`,
    custodySettlementLines: (id: number) => `/api/v1/finance/custodies/${id}/settlement-lines`,
    cashReceipts: '/api/v1/finance/cash-receipts',
    cashReceiptVoid: (id: number) => `/api/v1/finance/cash-receipts/${id}/void`,
    journalEntry: (id: number) => `/api/v1/finance/journal-entries/${id}`,
    reportsTrialBalance: '/api/v1/finance/reports/trial-balance',
    reportsTrialBalancePdf: '/api/v1/finance/reports/trial-balance/pdf',
    reportsTrialBalanceExcel: '/api/v1/finance/reports/trial-balance/excel',
    reportsIncomeStatement: '/api/v1/finance/reports/income-statement',
    reportsIncomeStatementPdf: '/api/v1/finance/reports/income-statement/pdf',
    reportsIncomeStatementExcel: '/api/v1/finance/reports/income-statement/excel',
    reportsBalanceSheet: '/api/v1/finance/reports/balance-sheet',
    reportsBalanceSheetPdf: '/api/v1/finance/reports/balance-sheet/pdf',
    reportsBalanceSheetExcel: '/api/v1/finance/reports/balance-sheet/excel',
    reportsAging: '/api/v1/finance/reports/aging',
    accountLedger: (id: number) => `/api/v1/finance/accounts/${id}/ledger`,
  ...
  inventory: {
    ...
    purchaseOrderPay: (id: number) => `/api/v1/inventory/purchase-orders/${id}/pay`,
    purchaseOrderPayments: (id: number) => `/api/v1/inventory/purchase-orders/${id}/payments`,
  ...
  timeshare: {
    ...
    unitsAvailability: '/api/v1/timeshare/units/availability',
  ...
  users: {
    ...
    resetCredentials: (id: number) => `/api/v1/users/${id}/reset-credentials`,
