...
def _seed_blog_posts(db: Session) -> None:
    """محتوى حقيقي (مش بيانات تجريبية) — نفس فئة _seed_chart_of_accounts:
    آمن ومقصود يتشغّل على الإنتاج لوحده لو احتاج الأمر، بيانات نص حقيقية
    منقولة زي ما هي من مشروع elkheima-beach-resort القديم (طلب Mohamed
    2026-08-04) بنسختها العربية فقط — BlogPost في resort-os عمود واحد لكل
    حقل (مفيش title_ar/title_en منفصلين لسه)، والموقع التسويقي عربي أولاً.
    Idempotent بالـslug: تحديث المحتوى لو موجود (من غير ما يصفّر views_count
    الحقيقي)، إضافة لو مش موجود."""
    from datetime import timedelta
    from app.modules.core.models import Branch
    from app.core.kernel.models.user import User
    ...
    if not branch:
        return
    author = db.query(User).filter(User.role == "super_admin").order_by(User.id).first()
    if not author:
        return
    ...
    posts = [
        {
            "slug": "best-time-visit-sharm-el-sheikh",
            "title": "أفضل وقت لزيارة شرم الشيخ",
            "excerpt": "تخطط لرحلتك لشرم الشيخ؟ اكتشف أفضل المواسم للشاطئ والغطس والطقس المثالي.",
            "cover_image": "/images/beach/views/beach-view-12.webp",
            "days_ago": 5,
            "body": """<h2>الربيع (مارس–مايو): الموسم الذهبي</h2>
<p>يُعدّ الربيع أفضل وقت لزيارة شرم الشيخ. تتراوح درجات الحرارة بين 24–32°م، ومياه البحر الأحمر تصل إلى 22–25°م، والرؤية تحت الماء تتجاوز 30 متراً — مثالي للغطس والسنوركل.</p>
<h2>الخريف (سبتمبر–نوفمبر): الموسم الثاني</h2>
<p>يشبه الخريف الربيع من حيث جودة الطقس. تقل الحشود الصيفية، وتنخفض الأسعار قليلاً، ويبقى البحر دافئاً من حرارة الصيف. درجات حرارة المياه تبقى حول 26–28°م.</p>
<h2>الشتاء (ديسمبر–فبراير): موسم الذروة السياحية</h2>
<p>يجلب الشتاء درجات حرارة معتدلة 18–22°م — جنة للأوروبيين الهاربين من البرد. هذا هو الموسم الأكثر ازدحاماً، لذا احجز مبكراً.</p>
<h2>الصيف (يونيو–أغسطس): للمغامرين</h2>
<p>قد تصل درجات الحرارة الصيفية إلى 38–40°م. لكن البحر في أدفأ حالاته (28–30°م) والرياضات المائية في أوجها. يُنصح بالأنشطة في الصباح الباكر والمساء.</p>
<h2>منتجع الخيمة: جنة على مدار السنة</h2>
<p>في منتجع الخيمة الشاطئي، نوفر شاطئاً خاصاً وكراسي مظللة وحمامات سباحة منعشة — مما يجعل أي موسم مريحاً ولا يُنسى. مطعمنا يقدم أشهى المأكولات البحرية الطازجة مع إطلالة خلابة على البحر الأحمر.</p>""",
        },
        {
            "slug": "diving-snorkeling-red-sea-guide",
            "title": "الدليل الكامل للغطس والسنوركل في البحر الأحمر",
            "excerpt": "كل ما تحتاج معرفته عن الغطس والسنوركل في شرم الشيخ — من نصائح المبتدئين إلى أفضل الأماكن.",
            "cover_image": "/images/activities/intro-diving.jpg",
            "days_ago": 12,
            "body": """<h2>لماذا البحر الأحمر؟</h2>
<p>يوفر البحر الأحمر من أروع المناظر تحت الماء في العالم. مياه صافية بوضوح يصل إلى 30–40 متراً، وشعاب مرجانية نابضة بالحياة، وأكثر من 1200 نوع من الأسماك تجعله جنة للغواصين. درجات حرارة المياه تتراوح من 20°م شتاءً إلى 30°م صيفاً.</p>
<h2>السنوركل للمبتدئين</h2>
<p>لا تحتاج إلى أي شهادة للسنوركل. فقط ضع القناع والزعانف والأنبوب، وارتمِ فوق الشعاب المرجانية. المياه الضحلة بالقرب من شاطئ الخيمة الخاص مثالية للمبتدئين — تيارات هادئة، ورؤية ممتازة، وحياة بحرية ملونة على بعد أمتار من الشاطئ.</p>
<p><strong>نصائح للمبتدئين:</strong></p>
<ul>
<li>تدرب على التنفس عبر الأنبوب في المياه الضحلة أولاً</li>
<li>لا تلمس الشعاب المرجانية أبداً — فهي هشة ومحمية</li>
<li>استخدم واقي شمس آمن للشعاب المرجانية</li>
<li>اذهب في الصباح للحصول على أهدأ الظروف</li>
</ul>
<h2>الغطس التمهيدي (بدون شهادة)</h2>
<p>تريد الذهاب لعمق أكبر؟ تجربة الغطس التمهيدية لدينا مصممة للمبتدئين الكاملين. مدرب معتمد يرافقك طوال الغطس، ويدير معداتك ويرشدك بأمان إلى أعماق 6–8 أمتار. لا تحتاج إلى خبرة سابقة.</p>
<h2>ماذا ستشاهد؟</h2>
<p>توقع مقابلة أسماك الببغاء الملونة، وأسماك المهرج في منازلها من الشقائق، والسلاحف البحرية الرشيقة، وإذا كنت محظوظاً — الدلافين. الحدائق المرجانية بالقرب من شرم الشيخ من أكثر الأماكن تنوعاً بيولوجياً في العالم.</p>
<h2>احجز تجربتك في الخيمة</h2>
<p>نوفر جلسات سنوركل وغطس تمهيدي يومية مباشرة من شاطئنا الخاص. كل المعدات متوفرة، ومدربونا ذوو الخبرة يضمنون سلامتك ومتعتك طوال الوقت.</p>""",
        },
        {
            "slug": "honeymoon-romantic-sharm-el-sheikh",
            "title": "رحلة رومانسية: دليل شهر العسل في شرم الشيخ",
            "excerpt": "تخطط لشهر عسلك؟ اكتشف لماذا شرم الشيخ هي واحدة من أكثر الوجهات رومانسية في الشرق الأوسط.",
            "cover_image": "/images/manage-page/honeymoon-package.webp",
            "days_ago": 20,
            "body": """<h2>لماذا شرم الشيخ لشهر العسل؟</h2>
<p>تجمع شرم الشيخ بين الجمال الطبيعي الخلاب — المياه الفيروزية، وغروب الشمس الذهبي، وسماء الصحراء المرصعة بالنجوم — مع ضيافة عالمية المستوى. إنها وجهة تأتي فيها الرومانسية بشكل طبيعي.</p>
<h2>عشاء غروب الشمس على البحر</h2>
<p>تخيل أنك تتناول العشاء مع شريكك بينما تغرب الشمس في البحر الأحمر، وتلون السماء بدرجات البرتقالي والوردي. في مطعم الخيمة على الشاطئ، نخلق هذه التجربة السحرية كل مساء. مأكولات بحرية طازجة، وطاولات بضوء الشموع، وصوت الأمواج الهادئ — الأجواء الرومانسية المثالية.</p>
<h2>لحظات الشاطئ الخاص</h2>
<p>يوفر شاطئنا الخاص أماكن منعزلة للأزواج — كراسي مريحة، ومياه صافية كالكريستال، والخصوصية التي تستحقانها في شهر العسل. استمتعا بسباحة الصباح، ونزهات الغروب على الشاطئ، ومراقبة النجوم ليلاً.</p>
<h2>الرياضات المائية للاثنين</h2>
<p>شاركا في إثارة السنوركل معاً، واكتشفا العالم تحت الماء يداً بيد. أو جربا رحلة قارب رومانسية عند غروب الشمس على طول الساحل. هذه المغامرات المشتركة تخلق ذكريات تدوم مدى الحياة.</p>
<h2>باقة شهر العسل من الخيمة</h2>
<p>تشمل باقة شهر العسل لدينا: دخول الشاطئ الخاص، وعشاء رومانسي لشخصين، وجلسة سنوركل للأزواج، وتزيين الغرفة بالزهور والشموع، وعصير ترحيبي مجاني عند الوصول. تواصل معنا لتخصيص رحلتك الرومانسية المثالية.</p>""",
        },
        {
            "slug": "family-vacation-sharm-el-sheikh-kids",
            "title": "عطلة شاطئية عائلية: نصائح لزيارة شرم الشيخ مع الأطفال",
            "excerpt": "تخطط لرحلة عائلية إلى شرم الشيخ؟ إليك كل ما تحتاج معرفته لجعلها مثالية للأطفال من جميع الأعمار.",
            "cover_image": "/images/packages/family-package.webp",
            "days_ago": 28,
            "body": """<h2>لماذا تحب العائلات شرم الشيخ؟</h2>
<p>شرم الشيخ هي واحدة من أكثر الوجهات الملائمة للعائلات في الشرق الأوسط. المياه الهادئة والضحلة للبحر الأحمر آمنة للأطفال، والطقس يمكن التنبؤ به، وهناك وفرة من الأنشطة لجميع الأعمار.</p>
<h2>سلامة الشاطئ للأطفال</h2>
<p>يتميز الشاطئ الخاص في منتجع الخيمة بنقاط دخول هادئة وضحلة مثالية للسباحين الصغار. موظفو الشاطئ لدينا حاضرون دائماً لضمان السلامة. يمكن للأطفال ممارسة السنوركل في مناطق الشعاب الضحلة تحت إشراف مناسب — تجربة تعليمية وسحرية لن ينسوها أبداً.</p>
<h2>أنشطة للأطفال</h2>
<ul>
<li><strong>السنوركل:</strong> يمكن للأطفال من عمر 8 سنوات فأكثر الاستمتاع بجلسات السنوركل الموجهة</li>
<li><strong>كرة الشاطئ:</strong> ملعبنا على الشاطئ مثالي للألعاب العائلية</li>
<li><strong>حمامات السباحة:</strong> مناطق سباحة آمنة وخاضعة للإشراف</li>
<li><strong>سفاري الصحراء:</strong> تجربة بدوية لنصف يوم يحبها الأطفال كثيراً</li>
</ul>
<h2>تناول الطعام مع الأطفال</h2>
<p>يقدم مطعمنا قائمة طعام مخصصة للأطفال إلى جانب القائمة الكاملة للبالغين. عصائر طازجة، ومعكرونة، ودجاج مشوي، وأطباق مصرية محلية — ما يناسب كل الأذواق الصغيرة. كراسي أطفال ومقاعد ملائمة للعائلات متوفرة دائماً.</p>
<h2>نصائح عملية</h2>
<ul>
<li>زوروا في الربيع (مارس–مايو) أو الخريف (سبتمبر–نوفمبر) لأكثر درجات الحرارة راحة</li>
<li>احضروا واقي شمس آمن للشعاب المرجانية — الشمس المصرية قوية طوال العام</li>
<li>احجزوا الباقة العائلية لأفضل قيمة ومرافق مخصصة للعائلات</li>
</ul>""",
        },
        {
            "slug": "food-guide-sharm-el-sheikh",
            "title": "ماذا تأكل في شرم الشيخ: دليل عشاق الطعام",
            "excerpt": "من المأكولات البحرية الطازجة من البحر الأحمر إلى المطبخ المصري الأصيل — اكتشف أفضل تجارب الطعام في شرم الشيخ.",
            "cover_image": "/images/restaurant/food/food-01.webp",
            "days_ago": 35,
            "body": """<h2>المأكولات البحرية الطازجة من البحر الأحمر</h2>
<p>البحر الأحمر موطن لتنوع رائع من الأسماك، ومطاعم شرم الشيخ تستفيد منها بالكامل. سمك القاروص المشوي، والكاليماري، والروبيان، والكركند — كلها طازجة يومياً. في مطعم الخيمة، يُعدّ طهاتنا المأكولات البحرية بتأثيرات مصرية ومتوسطية، لتقديم أطباق أصيلة وراقية في آن واحد.</p>
<h2>الكلاسيكيات المصرية</h2>
<p>لا تفوّت فرصة تجربة الأطباق المصرية التقليدية خلال إقامتك. الكشري (أرز وعدس ومكرونة مع صلصة الطماطم والبصل المقرمش) هو الطبق الوطني المحبوب في مصر. الفول المدمس يصنع فطوراً شهياً. الكفتة المشوية والشاورما مثالية لغداء غير رسمي.</p>
<h2>المطبخ الإيطالي بلمسة مصرية</h2>
<p>يتخصص مطبخنا في الدمج الإيطالي المصري — معكرونة طازجة يومياً، وبيتزا بالفرن الحجري، وريزوتو محضر بمكونات البحر الأحمر المحلية. إنها تجربة طهي فريدة لن تجدها في أي مكان آخر.</p>
<h2>العصائر الطازجة والمشروبات</h2>
<p>مصر مشهورة بعصائر الفاكهة الطازجة — المانجو والجوافة وقصب السكر والتمر هندي من المفضلات المحلية. يقدم كافيهنا عصائر معصورة طازجة إلى جانب القهوة المتخصصة والشاي العشبي.</p>
<h2>تناول الطعام في الخيمة</h2>
<p>يقدم مطعمنا على الشاطئ الفطور والغداء والعشاء مع إطلالة خلابة على البحر الأحمر. سواء فضّلت غداءً غير رسمي على الشاطئ أو عشاءً رومانسياً بضوء الشموع، نصنع تجربة الطعام المثالية لكل مناسبة.</p>""",
        },
        {
            "slug": "el-kheima-resort-hidden-gem-sharm",
            "title": "5 أسباب تجعل منتجع الخيمة الجوهرة الخفية في شرم الشيخ",
            "excerpt": "اكتشف ما يجعل منتجع الخيمة الشاطئي يتميز عن غيره في شرم الشيخ.",
            "cover_image": "/images/beach/views/beach-view-12.webp",
            "days_ago": 45,
            "body": """<h2>1. وصول حقيقي لشاطئ خاص</h2>
<p>على عكس كثير من المنتجعات التي تشارك مساحة الشاطئ، يوفر الخيمة تجربة شاطئ خاص حقيقية. امتدادنا من ساحل البحر الأحمر حصري لضيوفنا فقط — لا ازدحام، لا ضوضاء، فقط أنت والبحر. الشعاب المرجانية متاحة مباشرة من شاطئنا، مما يجعل السنوركل سهلاً وبلا مجهود.</p>
<h2>2. الضيافة المصرية الأصيلة</h2>
<p>نحن لسنا سلسلة دولية بلا وجه. الخيمة منتجع تديره عائلة حيث يُعامَل كل ضيف كضيف شخصي. موظفونا يعرفون اسمك، ويتذكرون تفضيلاتك، ويبذلون قصارى جهدهم لجعل إقامتك مميزة.</p>
<h2>3. مطبخ عالمي المستوى مع إطلالة</h2>
<p>يجمع مطعمنا على الشاطئ بين المطبخ المصري والإيطالي والعالمي مع إطلالة بانورامية على البحر الأحمر. مكونات طازجة، وطهاة خبراء، وأجواء تجعل كل وجبة مناسبة — سواء كانت فطوراً بسيطاً أو عشاءً رومانسياً.</p>
<h2>4. جميع الرياضات المائية في مكان واحد</h2>
<p>من السنوركل للمبتدئين إلى الغطس التمهيدي، وركوب الموز إلى ركوب الأمواج — جميع الرياضات المائية متاحة مباشرة من شاطئنا. لا حاجة للسفر إلى منشأة منفصلة؛ كل شيء على بعد خطوات من كرسيك.</p>
<h2>5. موقع لا يُضاهى</h2>
<p>يقع الخيمة في قلب منطقة السوق القديم في شرم الشيخ (خليج شرم الماية)، مما يضعك على مسافة قريبة من المطاعم المحلية والمحلات التجارية والحياة الليلية — مع الاحتفاظ بهدوء منتجع الشاطئ الخاص.</p>""",
        },
    ]

    added, updated = 0, 0
    for p in posts:
        row = db.query(BlogPost).filter(
            BlogPost.branch_id == branch.id, BlogPost.slug == p["slug"],
        ).first()
        published_at = datetime.combine(today - timedelta(days=p["days_ago"]), datetime.min.time())
        if row:
            row.title, row.excerpt, row.body = p["title"], p["excerpt"], p["body"]
            row.cover_image, row.status, row.published_at = p["cover_image"], "published", published_at
            updated += 1
        else:
            db.add(BlogPost(
                branch_id=branch.id, author_id=author.id, status="published",
                title=p["title"], slug=p["slug"], excerpt=p["excerpt"], body=p["body"],
                cover_image=p["cover_image"], published_at=published_at,
            ))
            added += 1
    if added or updated:
        db.flush()
        print(f"  ✓ Blog posts seeded ({added} added, {updated} updated)")
