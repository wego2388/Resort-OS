...
> **آخر تحديث حقيقي:** 2026-07-16 — كل رقم في الملف ده اتأكد منه فعليًا (تشغيل تست، تجربة live)،
...
| **الاختبارات** | **1791 اختبار، كلهم شغالين** ✅ (+3 اختبار Postgres-only اختياري لـ migration الدايننج، skip افتراضيًا) (2026-07-17، بعد Click ERP batch: destination الخزنة + تسعير حسب القناة) |
...
pytest tests/ -v               # 1786 اختبار (2026-07-16) — الرقم بيتغيّر، شغّله بنفسك لو محتاج التأكيد
```
...
2026-07-13)، 1786 اختبار شغالين. اتأكد من أي حاجة بتشتغل عليها بتشغيل الاختبارات و/أو تجربة live مش
