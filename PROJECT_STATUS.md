...
| **الاختبارات** | **1299 اختبار، كلهم شغالين** ✅ |
...
| **hr** (الموارد البشرية) | 455 | 39 | ✅ قوي — **2 باج مالي خطير اتصلح**: الجزاء مكانش بيأثر على الراتب، وتحديث الضرائب كان بيصفّر ضريبة الشهر الحالي؛ زرع بيانات حقيقية (كان فاضي 100%) |
| **restaurant** (المطعم) | 476+ | 28+ | ✅ الأنضج — order→kitchen→payment كامل؛ طاولات اتزرعت (كانت فاضية)، باج توقيت في KDS اتصلح |
| **beach** (الشاطئ) | 475+ | 21 | ✅ قوي — row-locking حقيقي بعد باج خفي في إصلاح سابق (SQLAlchemy identity map)، عقد B2B منتهي كان بيتقبل، حد ائتمان/تأخر سداد B2B اتضاف (2026-07-06) |
