...
| **الاختبارات** | **1426 اختبار، كلهم شغالين** ✅ |
...
| **restaurant** (المطعم) | 476+ | 29+ | ✅ الأنضج — order→kitchen→payment كامل؛ طاولات اتزرعت (كانت فاضية)، باج توقيت في KDS اتصلح؛ وصفة/BOM حقيقية (خصم مخزون تلقائي)؛ **تقرير تكلفة الطعام/COGS جديد** (تكلفة نظرية مقابل الإيراد الفعلي + تنبيهات، `/admin/food-cost`) |
| **beach** (الشاطئ) | 475+ | 27+ | ✅ قوي — row-locking حقيقي بعد باج خفي في إصلاح سابق (SQLAlchemy identity map)، عقد B2B منتهي كان بيتقبل، حد ائتمان/تأخر سداد B2B اتضاف (2026-07-06)؛ **خريطة شاطئ حية جديدة** (`/pos/beach-map`، مواقع فعلية بحالة/تشيك-إن حقيقي، بث WebSocket لحظي) |
| **cafe** (الكافيه) | 310+ | 19+ | ✅ منيو حقيقي، POS شغال، وصفة/BOM حقيقية (نفس ميزة المطعم)؛ **تقرير تكلفة الطعام/COGS جديد** (نفس ميزة المطعم) — لسه بدون أي شاشة إدارة طلبات (لا إلغاء ولا استرجاع من الواجهة) |
