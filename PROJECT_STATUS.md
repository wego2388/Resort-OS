...
| **الاختبارات** | **1106 اختبار، كلهم شغالين** ✅ |
...
| **finance** (الحسابات) | 772+ | 45+ | ✅ الأقوى — إهلاك أصول + تسوية بنكية (باك إند وفرونت إند)، 100% coverage |
...
| **timeshare** (التايم شير) | 477+ | 21+ | ✅ تخصيص وحدة/غرفة حقيقي + منع تعارض حجز + تقييم رضا العميل |
| **pms** (الفنادق/الغرف) | 273 | 16 | 🟡 متوسط، 52 غرفة حقيقية اتزرعت النهاردة (كان الجدول فاضي) |
| **crm** (العملاء) | 173+ | 22+ | ✅ Campaigns بقت ميزة حقيقية كاملة (كانت جدول ميت) |
| **maintenance** (الصيانة) | 183 | 14 | ✅ فرونت إند كامل بُني النهاردة (كان بدون أي شاشة خالص) |
| **leasing** (الإيجارات) | 251 | 9 | ✅ فرونت إند كامل بُني النهاردة (كان بدون أي شاشة خالص) |
...
14 موديول (كلهم دايمًا شغالين، مفيش تفعيل/تعطيل)، 1106 اختبار شغالين. اتأكد من أي حاجة بتشتغل عليها
