...
**2FA enrollment gate إجباري:** `super_admin`, `accountant`. التحقق بـTOTP عند
كل login مدعوم بإعداد `LOGIN_2FA_ENFORCED` لكنه false افتراضيًا حاليًا؛ قرار
0003 يفرض تفعيله والتحقق منه فعليًا في الإنتاج قبل Public Phase 0.
