...
- تأثير على Tests (هل كل الاختبارات لا تزال تعدي؟ الرقم بيتغيّر، شغّل `pytest -v` بنفسك)
...
☐ Error handling كامل
☐ لا N+1 queries
☐ pytest tests/ -v لا يزال يعدي 100% (1133 آخر رقم مؤكد — شغّله بنفسك، الرقم بيتغيّر)
