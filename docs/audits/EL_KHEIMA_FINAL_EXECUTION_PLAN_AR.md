...
- `manual/02-دليل-الموظفين-والتدريب.md` هو المرجع العربي لتدريب الأقسام: الدخول
  والحسابات والأدوار والصلاحيات، PMS وDining وBeach، المالية والتكلفة،
  المخزون والموردون، HR، الملكية الجزئية، CRM وخدمة العملاء والصيانة.
- يتضمن فصل المسؤوليات، قوائم فتح/إغلاق اليوم، معالجة المشاكل، سيناريوهات
  UAT، ونموذج اعتماد الموظف.
- `manual/01-دليل-السوبر-أدمن.md` هو المرجع الأمني المكمل لإدارة الحسابات
...
2. توزيع `manual/02-دليل-الموظفين-والتدريب.md` على رؤساء الأقسام وتنفيذ مصفوفة
