...
> 2026-08-09، قرار أسعار الإقامة، خطة الملكية الجزئية غير المنفذة، وتصميم شهر
...
4. ثبّت base commit/worktree للحزمة. لو تغييرات الملكية الجزئية الحالية غير مفهومة،
...
3. خطة الملكية الجزئية الحالية منفذة بعد التصحيحات في §8، لا حرفيًا قبل مراجعتها.
...
- إدخال سيناريوهات ملكية جزئية وزيارات وأقساط وصيانة استرشادًا بملف Excel.
...
- سعر الليلة يطبق على الحجز النقدي/direct/online. زيارة مالك Timeshare داخل
  ...
  رسوم موثقة بدل خلط سعر الإقامة بقيمة عقد الملكية الجزئية.
...
### 4.1 ملف محاسبة الملكية الجزئية

- **المصدر:** `/home/wego/Downloads/محاسبة ملكية جزئية .xlsx`.
- **SHA-256:**
...
### سيناريوهات الملكية الجزئية في يوليو
