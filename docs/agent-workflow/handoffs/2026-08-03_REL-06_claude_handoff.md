...
لموديول الملكية الجزئية تحديدًا (عقود/أقساط/استيراد/بوابة الضيف). طلعت فجوتين
...
- **ملكية جزئية**: إدارة وحدات فعلية (CRUD)، قائمة انتظار حقيقية (تحويل
...
الكود العام (المستودع على GitHub) يقدر يوقّع توكن بوابة عميل ملكية جزئية
مزوّر بمفتاح فاضي/معروف، ويشوف بيانات أي عميل ملكية جزئية ويقدّم طلبات
...
- **14 اختبار جديد** لتنبيهات بوابة الملكية الجزئية (الاتجاهين) + مؤشرات
...
- توثيق ملكية جزئية الإضافي (استيراد Excel، تقارير، عقود/أقساط تفصيليًا) لسه
